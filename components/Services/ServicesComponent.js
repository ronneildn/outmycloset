        ...
        switch (type) {
            case "counseling":
                data = {
                    title: "Counseling",
                    description:
                        "OMC conducts group and individual counseling by trained and experienced individuals such as Social Workers, Clinicians, Life Coaches and other experienced counselors. Some of the group topics which we offer may include Art/Music Therapy, Physical Health and Mental health, Vocational/Educational training and career development, Life Skills, Family Therapy, Substance Abuse etc.",
                    icon: <CounselingIcon />,
