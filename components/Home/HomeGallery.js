    ...
    return (
        <div className={classes.root}>
            <div className={classes.background}>
                <div className={classNames(classes.backgroundLayer1, classes.background)}></div>
                <div className={classNames(classes.backgroundLayer2, classes.background)}></div>
            </div>
                ...
                >
                    {
                        images.map((item) => {
                            return(
                                <div key={item._id} className={classes.imageContainer}>
                                    <Image
