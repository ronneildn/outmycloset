        ...
        <div className={classes.root}>
            <PublicContent margin>
                <SectionHeader
                    title={"News & Media"}
                    subTitle={
                        "There are several ways in which you can keep up with the latest moves and shakes from OMC. Follow our social media accounts to see in depth, behind the scenes progress of our strides in serving our community."
                    }
                />
